        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                calcbutton('AC', Color(0xffFB8C00), Colors.black),
                calcbutton('+/-', Color(0xffFB8C00), Colors.black),
                calcbutton('%', Color(0xffFB8C00), Colors.black),
                calcbutton('/', Color(0xff1A237E), Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: [
                ...
                calcbutton('x', Color(0xff1A237E), Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
